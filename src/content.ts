    ...
    <header class="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm">
      <div class="container mx-auto px-6 py-5">
        <div class="flex items-center justify-between">
          ...
          <button class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm h-9 rounded-md px-3 bg-foreground text-background hover:bg-foreground/90 font-medium">Get Started</button>
        </div>
      </div>
    </header>
      ...
      <div class="container mx-auto px-6 py-32 relative z-10">
        <div class="max-w-5xl mx-auto text-center animate-fade-in">
          ...
          <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button class="inline-flex items-center justify-center gap-2 h-11 bg-foreground text-background hover:bg-foreground/90 font-medium px-10 py-6 rounded-full">Start Publishing</button>
